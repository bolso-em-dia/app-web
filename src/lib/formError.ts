...
export const ERROR_CODE_MAP: Record<number, MessageKey> = {
  ...
  40904: "error.transactionDateConfirmationMismatch",
  40905: "error.newTransactionDateConfirmationMismatch",
  ...
  42221: "error.referenceMonthPolicyNotAllowed",
  42222: "error.moveToNextMonthNotAllowed",
  42223: "error.referenceMonthPolicyUpdateNotAllowed",
  42224: "error.moveTransactionDateFutureScopeNotAllowed",
