...
export function createArchiveCategorySchema(t: Translate) {
  ...
  return z.object({
    replacementCategoryId: z.string().min(1, message("validation.requiredReplacementCategory")),
  });
}

export type CategoryFormValues = z.infer<ReturnType<typeof createCategorySchema>>;
export type ArchiveCategoryFormValues = z.infer<ReturnType<typeof createArchiveCategorySchema>>;
