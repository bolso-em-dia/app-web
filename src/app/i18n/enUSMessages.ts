...
export const enUSMessages: Partial<Record<MessageKey, string>> = {
  ...
  "family.newDescription": "Add a new family member with an initial role and access.",
  "family.detailsTitle": "Member details",
  "family.editDescription": "Update the member role, status, or set a new password.",
