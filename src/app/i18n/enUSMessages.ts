...
export const enUSMessages: Partial<Record<MessageKey, string>> = {
  ...
  "error.transactionDateConfirmationMismatch": "The confirmed current date does not match the saved transaction.",
  "error.newTransactionDateConfirmationMismatch": "The confirmed new date does not match the next allowed date.",
  ...
  "error.referenceMonthPolicyNotAllowed": "Reference month policy is not allowed for this transaction.",
  "error.moveToNextMonthNotAllowed": "Only manual or installment transactions can move to the next month.",
  "error.referenceMonthPolicyUpdateNotAllowed": "Only manual credit-card expenses support reference month policy changes.",
  "error.moveTransactionDateFutureScopeNotAllowed": "Moving future installments is only allowed for installment transactions.",
  ...
  "transactions.moveDateTitle": "Move transaction date",
  "transactions.moveDateSubtitle": "Confirm the date change for the selected transaction.",
  "transactions.moveDateCurrent": "Current date: {{date}}",
  "transactions.moveDateNew": "New date: {{date}}",
  "transactions.moveDateFutureToggle": "Move future installments too",
  "transactions.moveDateInstallmentHint": "Future installments in this group will also move to the next month.",
  "transactions.moveDateAction": "Move date",
  "transactions.moveError": "Unable to move the transaction date.",
